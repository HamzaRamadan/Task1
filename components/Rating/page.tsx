  ...
  return (
    <div className="flex items-center gap-3 w-full lg:w-[80%]">
      ...
      <div className="flex-1 h-2 bg-[#E6E6E6] rounded-full overflow-hidden">
        <div className="h-full bg-[#BE968E]" style={{ width: `${percent}%` }} />
      </div>

      <span className="text-lg text-[#545454] w-10 text-right">%{percent}</span>
    </div>
  );
};
...
const ReviewItem = () => {
  return (
   ...
   <div className="flex flex-row justify-between items-center gap-2 mb-2 w-full flex-wrap">
...
export default function RatingReviews() {
  return (
    <section className="w-full max-w-6xl mx-auto p-4 sm:p-6">
      ...
      <h2 className="text-2xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-[#020202] font-Poppins">
        Rating & Reviews
        <div className="w-[40px] h-[4px] bg-[#BE968E] rounded-[16px]  mt-1" />
      </h2>
  ...
  <span className="text-[#020202] font-[500] text-[120px] leading-none">
    4,5
  </span>
  <span className="text-[#B0B0B0] font-[500] text-[24px] leading-none">
    /5
  </span>
</div>
        ...
        {/* Total Reviews */}
        <div className="hidden sm:flex flex-col items-center justify-center gap-2 sm:gap-4 h-full">
  ...
  <button className="flex items-center justify-center gap-2 bg-[#c9a59b] text-white h-[40px] sm:h-[44px] px-4 sm:px-6 rounded-xl font-medium hover:opacity-90 w-full sm:w-fit">
    Add comment
    <MessageCircle size={20} strokeWidth={2.5} />
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="relative w-full flex flex-col sm:flex-row items-center">
          ...
          <div className="hidden sm:block sm:absolute left-0 max-w-[120px]">
            <Image src="/Layer_1.png" alt="" width={120} height={120} />
          </div>

          <div className="w-full sm:flex-1 flex justify-center mt-4 sm:mt-0">
            <button className="bg-[#F5F5F5] w-[200px] sm:w-[207px] h-[50px] sm:h-[53px] rounded-[12px] flex items-center justify-center p-3">
